            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-6 mb-10">
                    {cards.map((card, index) => (
                        <div
                            key={card.id}
                            className="p-4 rounded-3xl shadow hover:shadow-2xl transition cursor-pointer text-center text-black bg-gradient-to-br from-[#ffc9b2] via-[#fefcfb] to-[#ffe1c4]"
                            data-aos="fade-up"
                        ...
                        >
                            ...
                            <p className="text-black text-sm">{card.caption}</p>
                        </div>
                    ))}
                </div>
